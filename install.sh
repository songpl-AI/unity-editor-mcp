...
echo "  Enter the git URL of this repo + '?path=unity-plugin'"
echo "  e.g.  https://github.com/yourname/unity-editor-mcp.git?path=unity-plugin"
echo ""
echo "Option B — Manual copy:"
echo "  cp -r $SCRIPT_DIR/unity-plugin  /path/to/YourUnityProject/Assets/"
echo ""
